...
public struct AwsNodeManagement: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AwsNodeManagement`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AwsNodeManagement().with { $0.autoRepair = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AwsNodeManagement"
  }
