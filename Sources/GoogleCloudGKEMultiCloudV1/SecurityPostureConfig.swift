  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = SecurityPostureConfig().with { $0.vulnerabilityMode = ... }
  /// ```
  ...
  public enum VulnerabilityMode: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .vulnerabilityEnterprise: return 2
    ...
    public init(intValue: Int) {
      ...
      case 2: self = .vulnerabilityEnterprise
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .vulnerabilityEnterprise: return try container.encode(2)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.SecurityPostureConfig"
  }
