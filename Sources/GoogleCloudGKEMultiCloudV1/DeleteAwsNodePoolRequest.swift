...
public struct DeleteAwsNodePoolRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAwsNodePoolRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAwsNodePoolRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.DeleteAwsNodePoolRequest"
  }
