...
public class AwsClustersClient: Clients.AwsClustersProtocol {
  ...
  public func createAwsCluster(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try AwsCluster(fromAny: anyValueUnwrapped)
  ...
  public func createAwsNodePool(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try AwsNodePool(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
