...
public struct GenerateAzureClusterAgentTokenResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenerateAzureClusterAgentTokenResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateAzureClusterAgentTokenResponse().with { $0.accessToken = ... }
  /// ```
