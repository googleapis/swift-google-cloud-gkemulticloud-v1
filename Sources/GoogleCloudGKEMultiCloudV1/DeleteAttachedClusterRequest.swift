...
public struct DeleteAttachedClusterRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAttachedClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAttachedClusterRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.DeleteAttachedClusterRequest"
  }
