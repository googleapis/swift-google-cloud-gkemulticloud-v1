...
public struct GenerateAwsClusterAgentTokenResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenerateAwsClusterAgentTokenResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateAwsClusterAgentTokenResponse().with { $0.accessToken = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.GenerateAwsClusterAgentTokenResponse"
  }
