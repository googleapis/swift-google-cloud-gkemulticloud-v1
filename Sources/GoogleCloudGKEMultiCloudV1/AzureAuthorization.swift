...
public struct AzureAuthorization: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var adminUsers: [AzureClusterUser] = []
  ...
  ///
  /// ```
  /// let value = AzureAuthorization().with { $0.adminUsers = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AzureAuthorization"
  }
