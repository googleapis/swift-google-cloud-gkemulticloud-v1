...
public struct GenerateAzureClusterAgentTokenRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required.
  ...
  /// Initialize a new instance of `GenerateAzureClusterAgentTokenRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateAzureClusterAgentTokenRequest().with { $0.azureCluster = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.GenerateAzureClusterAgentTokenRequest"
  }
