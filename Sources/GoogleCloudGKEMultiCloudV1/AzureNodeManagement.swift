...
public struct AzureNodeManagement: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AzureNodeManagement`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureNodeManagement().with { $0.autoRepair = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AzureNodeManagement"
  }
