...
public struct DeleteAzureNodePoolRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAzureNodePoolRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAzureNodePoolRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.DeleteAzureNodePoolRequest"
  }
