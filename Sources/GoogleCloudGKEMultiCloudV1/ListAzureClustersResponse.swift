...
public struct ListAzureClustersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  public var azureClusters: [AzureCluster] = []
  ...
  /// Initialize a new instance of `ListAzureClustersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAzureClustersResponse().with { $0.azureClusters = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let azureClusters = CodingKeys(stringValue: "azureClusters")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AzureCluster].self, forKey: .azureClusters) {
      self.azureClusters = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.azureClusters, forKey: .azureClusters)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.ListAzureClustersResponse"
  }
