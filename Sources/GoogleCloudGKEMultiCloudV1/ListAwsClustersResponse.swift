...
public struct ListAwsClustersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  public var awsClusters: [AwsCluster] = []
  ...
  /// Initialize a new instance of `ListAwsClustersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAwsClustersResponse().with { $0.awsClusters = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let awsClusters = CodingKeys(stringValue: "awsClusters")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AwsCluster].self, forKey: .awsClusters) {
      self.awsClusters = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.awsClusters, forKey: .awsClusters)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.ListAwsClustersResponse"
  }
