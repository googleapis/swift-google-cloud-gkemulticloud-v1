...
public struct SurgeSettings: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SurgeSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SurgeSettings().with { $0.maxSurge = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.SurgeSettings"
  }
