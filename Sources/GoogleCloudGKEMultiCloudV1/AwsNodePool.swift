...
public struct AwsNodePool: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var config: AwsNodeConfig? = nil

  /// Required. Autoscaler configuration for this node pool.
  public var autoscaling: AwsNodePoolAutoscaling? = nil

  /// Required. The subnet where the node pool node run.
  public var subnetId: Swift.String = Swift.String()

  /// Output only. The lifecycle state of the node pool.
  public var state: AwsNodePool.State = AwsNodePool.State()
  ...
  public var errors: [AwsNodePoolError] = []

  /// Optional. The Management configuration for this node pool.
  public var management: AwsNodeManagement? = nil
  ...
  ///
  /// ```
  /// let value = AwsNodePool().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AwsNodePool"
  }
