...
public struct AwsAuthorization: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var adminUsers: [AwsClusterUser] = []
  ...
  /// For more info on RBAC, see
  /// https://kubernetes.io/docs/reference/access-authn-authz/rbac/#user-facing-roles
  public var adminGroups: [AwsClusterGroup] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `AwsAuthorization`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AwsAuthorization().with { $0.adminUsers = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AwsClusterUser].self, forKey: .adminUsers) {
      self.adminUsers = value
    }
    if let value = try container.decodeIfPresent([AwsClusterGroup].self, forKey: .adminGroups) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AwsAuthorization"
  }
