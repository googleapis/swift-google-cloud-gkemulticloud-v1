...
public struct SystemComponentsConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SystemComponentsConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SystemComponentsConfig().with { $0.tolerations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tolerations = CodingKeys(stringValue: "tolerations")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.SystemComponentsConfig"
  }
