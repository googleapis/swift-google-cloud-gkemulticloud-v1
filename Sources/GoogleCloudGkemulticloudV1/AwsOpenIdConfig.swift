...
public struct AwsOpenIdConfig: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// OIDC Issuer.
  ...
  /// Initialize a new instance of `AwsOpenIdConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AwsOpenIdConfig().with { $0.issuer = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.AwsOpenIdConfig"
  }
