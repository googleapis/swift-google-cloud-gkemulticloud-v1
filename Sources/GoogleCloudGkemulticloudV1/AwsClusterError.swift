...
public struct AwsClusterError: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Human-friendly description of the error.
  public var message: Swift.String = Swift.String()

  /// Initialize a new instance of `AwsClusterError`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AwsClusterError().with { $0.message = ... }
  /// ```
