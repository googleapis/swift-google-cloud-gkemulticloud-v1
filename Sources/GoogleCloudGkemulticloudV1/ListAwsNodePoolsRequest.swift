...
public struct ListAwsNodePoolsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponse.next_page_token]: <doc:ListAwsNodePoolsResponse/nextPageToken>
  ...
  /// request, if any.
  ///
  /// [google.cloud.gkemulticloud.v1.AwsClusters.ListAwsNodePools]: <doc:AwsClusters/listAwsNodePools(request:)>
  ...
  ///
  /// ```
  /// let value = ListAwsNodePoolsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkemulticloud.v1.ListAwsNodePoolsRequest"
  }
